...
class JapanDestinations extends StatefulWidget {
  const JapanDestinations({super.key});

  @override
  _JapanDestinationsState createState() => _JapanDestinationsState();
}

class _JapanDestinationsState extends State<JapanDestinations> {
  ...
  Widget _buildHeaderImage() {
    return Container(
        ...
        child: Stack(
          children: [
            Image.asset(
              'assets/images/japan_header.jpg',
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          _infoCard('Ideal For', 'Couple, Friends',
